...
class SelectInventoryItemDialog(BaseDialog):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle(_("Artikel aus Lager auswählen"))
        ...
        self.only_in_stock = QtWidgets.QCheckBox(_("Nur mit Bestand"), self)
        self.only_in_stock.setChecked(True)

        # Tabelle
        self.table = QtWidgets.QTableWidget(self)
        self.table.setColumnCount(5)
        self.table.setHorizontalHeaderLabels([_("Artikelnummer"), _("Bezeichnung"), _("Bestand"), _("Lagerort"), _("Preis")])
        ...
        # Buttons
        btn_ok = QtWidgets.QPushButton(_("Übernehmen"))
        btn_cancel = QtWidgets.QPushButton(_("Abbrechen"))
