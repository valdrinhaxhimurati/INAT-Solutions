...
class DBSettingsDialog(BaseDialog):
    ...
    def _on_test(self):
        ...
        if ok:
            ...
            QMessageBox.critical(self, _("Fehler"), _("Verbindung fehlgeschlagen:\n{err}"))
    ...
    def _on_save(self):
        ...
        if changed:
            ...
            res = QMessageBox.question(
                ...
                _("Die Datenbank-Einstellungen wurden geändert. Anwendung jetzt neu starten?"),
                QMessageBox.Yes | QMessageBox.No,
                QMessageBox.Yes
            )
            if res == QMessageBox.Yes:
