...
class LoginDialog(BaseDialog):
    def __init__(self, db_path, parent=None):
        ...
        title = QLabel(_("Anmeldung"))
        title.setAlignment(Qt.AlignCenter)
        title.setStyleSheet("font-size: 22px; font-weight: 400;")
        layout.addWidget(title)

        self.input_user = QLineEdit()
        self.input_user.setPlaceholderText(_("Benutzername"))
        self.input_user.setMinimumHeight(36)
        layout.addWidget(self.input_user)

        self.input_pass = QLineEdit()
        self.input_pass.setPlaceholderText(_("Passwort"))
        ...
        self.btn_login = QPushButton(_("Anmelden"))
    ...
    def check_login(self):
        ...
        QMessageBox.warning(self, _("Fehler"), _("Benutzername oder Passwort falsch"))
